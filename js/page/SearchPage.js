...
import { TextInput, TouchableOpacity, Platform, DeviceInfo, ActivityIndicator, FlatList, StyleSheet, Text, View, Button, RefreshControl } from 'react-native';
...
class SearchPage extends Component {
    ...
    genIndicator() {
        ...
        return search.hideLoadingMore ? <View style={{ height: 70 }}></View> :
...
const styles = StyleSheet.create({
    ...
    bottomButton: {
        ...
        position: 'absolute',
        left: 10,
        // top: GlobalStyles.window_height - 80 - (DeviceInfo.isIPhoneX_deprecated ? 34 : 0),
        bottom: 10,
        right: 10,
        borderRadius: 3
    },
